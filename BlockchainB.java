 ...
 *
 * Notes:
 *       This is mini-project B of the Blockchain assignment.
 *
...
public class BlockchainB
{
     ...
     */
    public BlockchainB(String data, String previousHash, long timeStamp)
    {
        this.data = data;
    ...
    {
        List<BlockchainB> blockchain = new ArrayList<>();
        ...
        BlockchainB genesisBlock = new BlockchainB("This is the genesis Dummy Block.", "0", new Date().getTime());
        ...
        BlockchainB firstBlock = new BlockchainB("This is the first Simple Block.", genesisBlock.getHash(), new Date().getTime());
        ...
        BlockchainB secondBlock = new BlockchainB("This is the second Simple Block.", firstBlock.getHash(), new Date().getTime());
        ...
        BlockchainB thirdBlock = new BlockchainB("This is the third Simple Block.", secondBlock.getHash(), new Date().getTime());
        ...
        BlockchainB fourthBlock = new BlockchainB("This is the fourth Simple Block.", blockchain.get(blockchain.size() - 1).getHash(), new Date().getTime());
